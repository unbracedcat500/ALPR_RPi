...
model_file = configColor.model_file
label_file = configColor.label_file
input_layer = configColor.input_layer
output_layer = configColor.output_layer
classifier_input_size = configColor.classifier_input_size
